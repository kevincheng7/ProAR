...
from src.utilities.utils import disable_inference_dropout, enable_inference_dropout, get_logger, get_loss
...
class BaseModel(LightningModule):
    ...
    def __init__(
        ...
        if loss_config is not None:
            loss_config["deterministic"] = deterministic
        self.criterion = get_loss(loss_function, loss_config)
    ...
    def get_named_parameters(self) -> list:
        """Return the parameters for the optimizer."""
    ...
    def predict_forward(self, inputs: Union[Tensor, Dict], metadata: Any = None, **kwargs):
